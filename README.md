...
- Added a unified `mapping/map_type` option so VoxelMap, R-VoxelMap-style recursive voxel mapping, and VoxelMap++ can be selected from configuration for comparative evaluation.
